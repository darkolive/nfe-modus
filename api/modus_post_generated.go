...
func __new(id int) unsafe.Pointer {
	...
	case 19:
		...
		return p
	case 20:
		o := new(auth.RegisterWebAuthnRequest)
		p := unsafe.Pointer(o)
		__pins[p]++
		return p
	case 21:
		o := new(auth.RegisterWebAuthnResponse)
		p := unsafe.Pointer(o)
		__pins[p]++
		return p
	case 22:
	...
	case 23:
		...
		return p
	case 24:
		o := new(auth.SignInWebAuthnRequest)
		p := unsafe.Pointer(o)
		__pins[p]++
		return p
	case 25:
		o := new(auth.SignInWebAuthnResponse)
		p := unsafe.Pointer(o)
		__pins[p]++
		return p
	case 26:
	...
	case 32:
		...
		return p
	case 33:
		o := new(auth.VerifyWebAuthnRegistrationRequest)
		p := unsafe.Pointer(o)
		__pins[p]++
		return p
	case 34:
		o := new(auth.VerifyWebAuthnRegistrationResponse)
		p := unsafe.Pointer(o)
		__pins[p]++
		return p
	case 35:
		o := new(auth.VerifyWebAuthnSignInRequest)
		p := unsafe.Pointer(o)
		__pins[p]++
		return p
	case 36:
		o := new(auth.VerifyWebAuthnSignInResponse)
		p := unsafe.Pointer(o)
		__pins[p]++
		return p
	case 37:
